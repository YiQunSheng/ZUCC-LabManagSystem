...
<body>
<%session.setAttribute("labId", request.getAttribute("labId"));   %>
<div class="container">
        ...
        <div class="col-md-12 column">
            <div class="jumbotron">
                ...
                <p>
                    ...
                    <a class="btn btn-primary btn-large" href="addComputerInput">添加计算机</a>
                </p>
            </div>
            ${msg}
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $(".deletebtn").click(function(){
            var r=confirm("确认要删除该计算机吗？");
            if(r===true){
                var id = $(this).parent().parent().children('.computerId').text();
                console.log(id);
                var bool;
                $.ajax({
                    data:{
